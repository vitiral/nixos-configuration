...
in
rec {
  novault = f: novault_0_4_2 { features = novault_0_4_2_features { novault_0_4_2 = f; }; };
  ...
  novault_0_4_2_ = { dependencies?[], buildDependencies?[], features?[] }: buildRustCrate {
    crateName = "novault";
    version = "0.4.2";
    authors = [ "Garrett Berg <vitiral@gmail.com>" ];
    sha256 = "0w7r0s8iyim9ghs77x21qbklk2k2jzngbifkxfjni9j6crdxc6iw";
    inherit dependencies buildDependencies features;
  };
  ...
  novault_0_4_2 = { features?(novault_0_4_2_features {}) }: novault_0_4_2_ {
  ...
  novault_0_4_2_features = f: updateFeatures f (rec {
    ...
    novault_0_4_2.default = (f.novault_0_4_2.default or true);
